        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <!-- Introduction -->
                    <p class="lead text-muted">By accessing and utilizing our website (<strong>IT Web Dream</strong>), you implicitly consent
                    ...
                    <p class="lead text-muted"><strong>License:</strong> IT Web Dream grants users a limited, non-exclusive, and revocable
                        license to access and use the website for non-commercial, informational purposes only.</p>

                    <p class="lead text-muted"><strong>Prohibited Activities:</strong> Users must not engage in unethical or unlawful conduct,
                        including:</p>
                    <ul>
                    ...
                    <p class="lead text-muted">Usage of this website is governed by our <a href="{{ route('privacy-policy') }}">Privacy Policy</a>.
                    </p>

                    <!-- Third-Party Links -->
                    <h2 class="h4 fw-bold mt-4">Links to Third-Party Websites</h2>
                    <p class="lead text-muted">Our website may contain links to third-party websites. IT Web Dream is not responsible for
                    ...
                    <p class="lead text-muted">IT Web Dream is not liable for any direct, indirect, incidental, special, or consequential
                        damages resulting from the use or inability to use the website.</p>

                    <!-- Refund Policy -->
                    <h2 class="h4 fw-bold mt-4">Refund Policy</h2>
                    <p class="lead text-muted">IT Web Dream aims for client satisfaction. After payment and contract execution, clients are
                    ...
                    <p class="lead text-muted">We reserve the right to update these terms at any time without notice. Users are encouraged to review
